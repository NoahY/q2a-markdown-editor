...
/*jslint browser:true, white:false, onevar:false, nomen:false, regexp:false, undef:false,
         eqeqeq:false, plusplus:false, bitwise:false */
/*globals window */
...
//
    ...
    text = _DoAutoLinks(text); /** SV: moved this up to avoid autolinks breaking regular links */
    text = _DoImages(text);
...
var _DoHeaders = function(text) {
    ...
    //
    text = text.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm,
        function(wholeMatch,m1){return hashBlock("<h2>" + _RunSpanGamut(m1) + "</h2>");});

    text = text.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm,
        function(matchFound,m1){return hashBlock("<h3>" + _RunSpanGamut(m1) + "</h3>");});
...
var _DoAutoLinks = function(text) {
	/** SV: brackets optional for links */
