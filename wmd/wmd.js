...
Attacklab.wmdBase = function(){
	...
	var helpLink = "http://en.wikipedia.org/wiki/Markdown"; // link for public distribution
// 	var helpLink = "http://pokemondb.net/pokebase/rules#markdown"; // link for my Q2A site
	var helpHoverTitle = "Help with formatting";
		...
		var setupEditor = function(){
			...
			if (inputBox.form) {
				...
				inputBox.form.onsubmit = function(){
					/** SV: don't convert to HTML on submission */
					//convertToHtml();
					if (submitCallback) {
